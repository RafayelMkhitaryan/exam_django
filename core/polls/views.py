...
def rate_course(request, course_id):
    ...
    if request.method == "POST":
        try:
            ...
            return render(request, "rate_course.html", {
                "course": course,
...
def register(request):
    if request.method == "POST":
        ...
        if password != repeat_password:
            return render(request, "register.html", {"error massage": "Password do not match"})
...
def login(request):
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, "login.html", {"error_message": "Missed Field"})
